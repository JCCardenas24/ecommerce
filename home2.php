          ...
          <div class="d-flex space-evenly">
            <div class="testimonial_card">
              <div class="content_testimonial">
                ...
                <span>★★★★★</span>
                <p>Estoy dando 4 estrellas ¿porque? bueno la app es muy buena pero lo único malo esque no puedo
                  descargar varias imágenes cuando estoy dentro de la app, tengo que salirme y entrar nuevamente .</p>
              </div>
            </div>
            <div class="testimonial_card">
              <div class="content_testimonial">
          ...
          <ul class="nav nav-tabs col-10 mx-auto p-0" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
              <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile"
                aria-selected="false">Autos</a>
            </li>
            <li class="nav-item" role="presentation">
              <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact"
                aria-selected="false">Homeowners</a>
            </li>
            <li class="nav-item" role="presentation">
              <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact"
                aria-selected="false">Renters</a>
            </li>
            <li class="nav-item" role="presentation">
              <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact"
                aria-selected="false">Condo</a>
            </li>
            <li class="nav-item" role="presentation">
              <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact"
                aria-selected="false">Motocicleta</a>
            </li>
          </ul>
