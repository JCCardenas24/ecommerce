<nav class="main-nav">
    ...
    <div class="d-flex align-items-center justify-content-between main-nav__secondaryRow">
        ...
        <div class="d-flex main-nav__secondaryRow__menuActions">
            <a class="main-nav__secondaryRow__menuActions btnLogin" href="">Iniciar sesión</a>
            <a class="main-nav__secondaryRow__menuActions btnCotizar" href="">Cotizar ahora</a>
            <div>
